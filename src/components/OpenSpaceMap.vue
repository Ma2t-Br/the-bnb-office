...
const mainTableSeats: Seat[] = [
  // Côté gauche (1 place)
  { id: 'seat1', name: 'P1', type: 'mainTable', position: { x: 0, y: 0 } },
  // Côté droit (1 places)
  { id: 'seat4', name: 'P4', type: 'mainTable', position: { x: 1, y: 0 } },
  // Extrémités (6 places chacune)
  { id: 'seat5', name: 'P5', type: 'mainTable', position: { x: 2, y: 5 } },
  { id: 'seat6', name: 'P6', type: 'mainTable', position: { x: 2, y: 0 } },
  { id: 'seat2', name: 'P2', type: 'mainTable', position: { x: 2, y: 1 } },
  { id: 'seat3', name: 'P3', type: 'mainTable', position: { x: 2, y: 2 } },
  { id: 'seat7', name: 'P7', type: 'mainTable', position: { x: 2, y: 3 } },
  { id: 'seat8', name: 'P8', type: 'mainTable', position: { x: 2, y: 4 } },
];
...
<template>
  <div class="max-w-lg mx-auto p-3">
    <h1 class="text-xl font-bold mb-3">Réservation Open Space</h1>
